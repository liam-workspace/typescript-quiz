 ...
 * clock. Service code takes a Clock; nothing here constructs a date or reads
 * the wall clock directly. Every deadline in this app is server-authoritative,
 * and createFixedClock is what turns an expiry test into an assertion rather
